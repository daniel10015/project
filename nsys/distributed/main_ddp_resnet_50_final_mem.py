...
def train_one_epoch(model, loader, optimizer, loss_fn, local_rank, memlog, max_batches=10):
    model.train()
...
def main():
    ...
    memlog.register_ddp_hooks(ddp_model)
