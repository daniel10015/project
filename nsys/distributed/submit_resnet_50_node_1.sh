...
OUT_NAME="profile_result_resnet_50_node_1_bs${BATCH_SIZE}_img${IMAGE_SIZE}_mb${MAX_BATCHES}"
...
srun --export=ALL nsys profile \
   ...
   --output=${OUT_DIR}/${OUT_NAME}_rank%q{SLURM_PROCID} \
    python main_ddp_resnet_50_node_1.py --batch_size ${BATCH_SIZE} --image_size ${IMAGE_SIZE} --max_batches ${MAX_BATCHES}
