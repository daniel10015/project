...
def train_one_epoch_prefetch(model, train_loader, optimizer, loss_fn, device, max_batches=None, debug_payload_bytes=0):
    ...
    prefetcher = CUDAPrefetcher(
        ...
        nvtx_push=nvtx_push,
        nvtx_pop=nvtx_pop,
        debug_payload_bytes=debug_payload_bytes,
    )
...
def main():
    ...
    for epoch in range(1, epoch_count + 1):
        train_acc = train_one_epoch_prefetch(model, train_loader, optimizer, loss_fn, "cuda", max_batches=20, debug_payload_bytes=128*1024*1024)
